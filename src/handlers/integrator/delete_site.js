import { softDeleteSiteByIntegratorId } from '../../core/delete_site.js'
import {
  error404,
  error500,
...
export default async (ctx, req, res) => {
  ...
  try {
    const site = await softDeleteSiteByIntegratorId(userId, clientIntegratorId, siteIntegratorId)

    if (!site) {
      return error404(res, 'The site could not be found')
    }
