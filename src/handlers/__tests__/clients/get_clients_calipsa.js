...
const { default: getClientsCalipsa } = await import('../../calipsa/get_clients.js')
...
describe('Get clients', () => {
  ...
  it('Has the correct response structure.', async () => {
    ...
    // Act
    await getClientsCalipsa(ctx, request, response)
  ...
  it('Should add links to the response.', async () => {
    ...
    const { links: clientLinks } = clients[0]
    ...
    expect(clientLinks).toEqual(expect.objectContaining({
